...
export default function useGamepad({
    ...
    const [pressedButtons, setPressedButtons] = useState<Set<GamepadButtonName>>(new Set());
    ...
    const isPressed = useCallback((key: GamepadButtonName) => pressedRef.current.has(key), []);
